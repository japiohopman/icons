          ...
          {assets.map((asset) => {
            ...
            return (
              ...
              >
                ...
                >
                  <GameIcon asset={asset} size={36} />
                </div>
                <div className="w-full text-center">
                  <div
                    className={`text-[10px] font-mono px-2 py-1 rounded truncate transition-all ${
                      isSelected ? 'bg-indigo-50 text-indigo-700 font-semibold' : 'bg-slate-50 text-slate-500'
                    }`}
                  >
                    {asset.name}
                  </div>
          ...
          return (
            <motion.div
              ...
              className={`grid grid-cols-[64px_200px_1fr_1fr_120px] gap-4 px-4 py-3 bg-white border rounded-xl items-center transition-all cursor-pointer ${
                isSelected
                  ? 'border-indigo-300 shadow-xs ring-2 ring-indigo-500/5 shadow-indigo-100'
            ...
            >
              ...
              >
                <GameIcon asset={asset} size={28} />
              </div>
              <div>
                <div className="font-bold text-slate-700 truncate">{asset.name}</div>
              ...
              <div>
                <span className="inline-block text-[10px] font-mono bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded border border-indigo-100 uppercase">
                  {asset.category}
                </span>
              </div>
